<div>
    ...
    <x-jet-dialog-modal wire:model="editModal">
        <x-slot name="title">
            <h2 class="text-3xl font-bold text-slate-800">{{__("Education details")}}</h2>
        ...
        <x-slot name="content">
            <div class="col-span-3">
                ...
                @enderror
                <p class="w-full text-justify mt-1 text-sm text-slate-600">{{__("If you received an alternative diploma or a diploma other than a high school diploma, please select Other as more options may display. In the U.S, this is high school or GED; outside the U.S., this can be high school, lyceum, gymnasium or secondary school.")}}</p>
            </div>
