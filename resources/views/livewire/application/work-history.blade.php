    ...
    <div class="grid grid-cols-3 gap-4">
        <div class="col-span-3">
            <div class="flex items-center justify-between">
                <h2 class="text-3xl font-bold text-slate-800">{{__("Work history")}}</h2>
            ...
            <div class="mt-6 col-span-3">
                <div class="grid grid-cols-2 gap-4">
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="employer_name" id="employer_name" wire:model="employer_name" class="mt-1 w-full">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        <label for="job_title" class="block text-sm font-semibold text-slate-800">{{__("Job title")}}</label>
                        <input type="text" name="job_title" id="job_title" wire:model="job_title" class="mt-1 w-full">
                    </div>
                </div>
            </div>
        @endif
            ...
            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                <div class="space-y-1 text-center">
                    ...
                    <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                        ...
                        <input id="file-upload" name="file-upload" wire:model="resume" type="file" class="sr-only" accept="application/pdf">
                    </label>
