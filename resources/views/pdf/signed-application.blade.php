    ...
    <body>
        ...
        <div style="margin-top: 1rem">
            ...
            <div style="margin-top: 2rem">
                ...
                <p style="font-size: 12px; font-weight:700; color: red; padding: 5px 5px 5px 5px; background-color: rgb(255, 227, 227); border-radius: 10px;">KEEP BOTH PAGES ATTACHED AT ALL TIMES</p>
            </div>
        </div>
    </body>
</html>
