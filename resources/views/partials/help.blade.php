        ...
        <ul class="text-left flex flex-col">
            ...
            <li>
                <a class="flex items-center gap-2 p-2 rounded hover:bg-sky-50 group hover:text-sky-600 transition-all duration-300" href="tel:+18447448723">
                    ...
                    <span>{{__("Give us a call")}}</span>
                </a>
            </li>
        </ul>
    </div>
    <button @click="helpMenu = ! helpMenu" class="px-5 py-3 rounded-full bg-sky-500/90 text-xs uppercase font-semibold tracking-wider backdrop-blur-sm text-white">{{__("Need help?")}}</button>
</div>
